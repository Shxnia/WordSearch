...
namespace GemMine.WordSearch {
	...
	public class menuScript : MonoBehaviour {
		...
		public void initializeCategories() {
			...
			container.GetComponent<RectTransform> ().sizeDelta = new Vector2 (100, numcat * 160);
			// set the scroll container's position
			container.GetComponent<RectTransform> ().anchoredPosition = new Vector2 (0, (250-numcat*160)/2);
			...
			foreach (category cat in categories) {
				...
				entry.GetComponent<RectTransform> ().anchoredPosition = new Vector2 (0,startpos-counter*80);
